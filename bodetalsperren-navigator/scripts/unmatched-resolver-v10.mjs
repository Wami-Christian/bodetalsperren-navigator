#!/usr/bin/env node
/**
 * HarzFishing – Unmatched Resolver v10
 *
 ...
 * Output:
 *   data/two-source-water-v6-2.generated.ts
 *   data/unmatched-v10-result.csv
 *   data/unmatched-v10-cache.json
 */
...
const REPORT=path.join(DATA,"unmatched-v10-result.csv");
const CACHE_FILE=path.join(DATA,"unmatched-v10-cache.json");
...
function render(index){return `// AUTO-GENERATED / updated by scripts/unmatched-resolver-v10.mjs
...
console.log("");
console.log("HarzFishing – Unmatched Resolver v10");
console.log("------------------------------------");
